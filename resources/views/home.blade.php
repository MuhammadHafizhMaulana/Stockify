  ...
  <div class="relative isolate px-6 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-38 sm:py-48 lg:py-32">
      ...
      <div class="text-center">
        <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Stockify Aplikasi Manajemen Gudang</h1>
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="{{ route('login') }}" class="rounded-md bg-indigo-500 px-9.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 ">Login</a>
          <a href="{{ route('register') }}" class="text-sm/6 font-semibold text-white">Don't have account, register here <span aria-hidden="true">→</span></a>
        </div>
      </div>
    </div>
