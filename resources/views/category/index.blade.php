...
<x-layout>
    ...
    <div class="w-full pb-2" x-data="{ open: false }">
        ...
        <div
            ...
            x-cloak
            x-transition
            class="border p-6 rounded-lg bg-gray-50 shadow"
        >
