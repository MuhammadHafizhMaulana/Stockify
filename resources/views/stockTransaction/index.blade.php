                                ...
                                @if (Auth::user()->role === 'manajer')
                                    @if ($stockTransaction->status === 'pending')
                                        <form action="{{ route('stockTransaction.approve', $stockTransaction->id) }}"
                                            ...
                                            @method('PATCH')
                                            <button type="submit"
                                                class="text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Accept</button>
                                        </form>
