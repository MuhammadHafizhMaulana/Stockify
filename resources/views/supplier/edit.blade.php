<x-layout>
    <div class="flex items-center justify-center m-5">
        ...
        <div
            class="h-fit bg-white border border-gray-200 shadow-2xs rounded-xl p-4 md:p-5 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 w-lg">
            <h1 class="py-3 text-center text-3xl text-bold">Edit Supplier</h1>
