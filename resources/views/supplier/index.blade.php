                    ...
                    @foreach ($suppliers as $supplier)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="{{ route('supplier.detail', $supplier->id) }}" class="button"> <button
                                        type="button"
                                        class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Detail</button></a>

                                {{-- Form delete --}}
                                @if ($supplier->product->isEmpty())
